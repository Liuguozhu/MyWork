 ...
 * @date 2014年10月20日
 */
public class TongbutuiIos extends TLOLMessageHandler {
	...
	public void handleReceived(LlpMessage msg) {
		...
		appKey = PayManager.instance().getTongbutuiIosAppkey();
	...
	public void handleReply() throws Exception {
		...
		try {
			message = LlpJava.instance().getMessage("s_tongbutuiIos");
