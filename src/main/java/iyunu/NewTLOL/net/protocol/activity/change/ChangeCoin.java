 ...
 * 
 */
public class ChangeCoin extends TLOLMessageHandler {
	...
	public void handleReceived(LlpMessage msg) {
		...
		if (!RoleServer.costMoney(online, money, EMoney.changeCoin)) {
			result = 1;
			reason = "";
		...
		int coin = ActivityJson.instance().getChangeCoin(money);
		RoleServer.addCoin(online, coin, EGold.changeCoin);
	}
	...
	public void handleReply() throws Exception {
		...
		try {
			llpMessage = LlpJava.instance().getMessage("s_changeCoin");
