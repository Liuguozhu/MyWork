...
public class Cell {
	 ...
	 * @return 格子对象
	 */
	public static Cell oldDecode(String str) {
		if ("".equals(str)) {
			return null;
		} else {
			Cell cell = new Cell();
			...
			cell.setIndex(Translate.stringToInt(strs[0]));
			if (item != null) {
	...
	public static Cell decode(String string) {
		Cell cell = new Cell();
		String[] strings = string.split("#");
		cell.setIndex(Translate.stringToInt(strings[0]));
