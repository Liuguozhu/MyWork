 ...
 * 
 */
public class ShenbingProcessorCenter extends Thread {
	...
	public void run() {
		while (process) {
			...
			Role role = MapManager.instance().getShenbingQueue();
			if (role != null) {
				MapMessage.refreshNearbyShenbing(role);
			}
