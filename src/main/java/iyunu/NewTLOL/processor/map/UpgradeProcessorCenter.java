 ...
 * 
 */
public class UpgradeProcessorCenter extends Thread {
	...
	public void run() {
		while (process) {
			...
			Role role = MapManager.instance().getUpgradeQueue();
			if (role != null) {
				MapMessage.refreshNearbyLevel(role);
			}
