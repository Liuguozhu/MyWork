 ...
 * 
 */
public class BloodFlagProcessorCenter extends Thread {
	...
	public void run() {
		while (process) {
			...
			Role role = MapManager.instance().getBloodQueue();
			if (role != null) {
				MapMessage.refreshNearbyBlood(role);
			}
