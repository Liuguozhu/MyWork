...
public class HashMapIntAndDailyModelType implements TypeHandler {

	@Override
	public Object getResult(ResultSet rs, String parameter) throws SQLException {
		String v = rs.getString(parameter);
		HashMap<Integer, Seven> map = JsonTool.decode(v, new TypeReference<HashMap<Integer, Seven>>() {
		});
		if (map == null) {
			map = new HashMap<Integer, Seven>();
		}
		return map;
	}
