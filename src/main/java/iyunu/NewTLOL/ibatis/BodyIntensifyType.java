...
public class BodyIntensifyType implements TypeHandler {

	@Override
	public Object getResult(ResultSet rs, String parameter) throws SQLException {
		String v = rs.getString(parameter);
		HashMap<EEquip, Integer> map = JsonTool.decode(v, new TypeReference<HashMap<EEquip, Integer>>() {
		});
		if (map == null) {
			map = new HashMap<EEquip, Integer>();
