...
public class LlpMessage {
	...
	public void write(String filedStr, int number) {
		...
		LogManager.llpLog("协议日志  [" + name + "]  " + filedStr + "=" + number);
		int ret = LlpJavaNative.llpWmesInt32(llpMesHandle, filedStr, number);
		if (ret == 0) {
			throw new RuntimeException("[LlpJavaNative WriteInt32]:  write message \"" + name + "\" filed \"" + filedStr + "\" number: " + number + " is error.");
		}
	}
	...
	public void write(String filedStr, boolean bool) {
		...
		LogManager.llpLog("协议日志  [" + name + "]  " + filedStr + "=" + bool);
		int number = bool ? 1 : 0;
		int ret = LlpJavaNative.llpWmesInt32(llpMesHandle, filedStr, number);
		if (ret == 0) {
			throw new RuntimeException("[LlpJavaNative WriteInt32]:  write message \"" + name + "\" filed \"" + filedStr + "\" number: " + number + " is error.");
	...
	public void write(String filedStr, long number) {
		...
		if (ret == 0) {
			throw new RuntimeException("[LlpJavaNative WriteInt64]:  write message \"" + name + "\" filed \"" + filedStr + "\" number: " + number + " is error.");
		}
	}
	...
	public void write(String filedStr, float number) {
		...
		if (ret == 0) {
			throw new RuntimeException("[LlpJavaNative Writefloat32]:  write message \"" + name + "\" filed \"" + filedStr + "\" number: " + number + " is error.");
		}
	}
	...
	public void write(String filedStr, double number) {
		...
		if (ret == 0) {
			throw new RuntimeException("[LlpJavaNative Writefloat64]:  write message \"" + name + "\" filed \"" + filedStr + "\" number: " + number + " is error.");
		}
	}
	...
	public void write(String filedStr, String str) {
		...
		LogManager.llpLog("协议日志  [" + name + "]  " + filedStr + "=" + str);
		int ret = LlpJavaNative.llpWmesString(llpMesHandle, filedStr, str);
		if (ret == 0) {
			throw new RuntimeException("[LlpJavaNative WriteString]:  write message \"" + name + "\" filed \"" + filedStr + "\" str: " + str + " is error.");
		}
	}
	...
	public void write(String filedStr, byte[] stream) {
		...
		LogManager.llpLog("协议日志  [" + name + "]  " + filedStr + "=" + stream);
